A describing of what each script in this directory is doing.
...
4-listmorefiles
Displays current directory contents in a long format, including hidden files.

5-listfilesdigitonly
Displays current directory contents, with user and group IDs displayed numerically in a long formand and including hidden files.
